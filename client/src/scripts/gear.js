...
const renderGear = async () => {
  try {
    ...
    const pathParts = window.location.pathname.split("/"); // issue was here
    ...
    console.log("All gears from server:", data);
